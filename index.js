...
let example4 = 3 * 3;
let example5 = 9 / 1;
let example6 = 3 - 0 + 5 / 2;
let example7 = 6 / 2 + 2;
let example8 = 12 + 12;
let example9 = 23 ** 15 ;
let example10 = ( 5 + 5 ) + 10;
let example11 = 10 % 2 ;
let example12 = 2.1 * 1.2;
let example13 = 91 ** ( 1 / 2 ); //корень
let example14 = 17 % 2; // остаток
let example15 = 64 ** ( 1 / 3 );


let example16 = 10 > 5;//сравнение
let example17 = 15 < 50;
let example18 = 10 === 10;
let example19 = 30 >= 20;
let example20 = 5 !== 15;// не равно
let example21 = 10 <= 10;

let a = 5 , b = 5 , c = 5 ;//все вместе можно 
...
if (month === "июнь" || month === "июль" || month === "август") {
    console.log("это лето");
}
if (month === " сеньтябрь" || month === "октябрь" || month === " ноябрь") {
    console.log("это осень");
}

//является ли пятница будним или выходным днем
let day = "вторник";
if (day === "понедельник" || day === "вторник" || day === "среда" || day === "четверг" || day === "пятница" ){
   console.log("это будний день");
} 
if (day === "суботта" || day === " воскресенье" ){
